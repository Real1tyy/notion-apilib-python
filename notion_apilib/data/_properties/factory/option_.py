...
def create_select_page(parent: "Page", name: str, option: OptionPage) -> SelectPage:
    """
...
def create_status_page(parent: "Page", name: str, status: OptionPage) -> StatusPage:
    """
...
def create_status_database(
        parent: "Database", name: str, options: list[OptionPage], groups: list[Group]
) -> StatusDatabase:
    """
