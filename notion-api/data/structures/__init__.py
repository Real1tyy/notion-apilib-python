"""
The `structures` package contains both the data classes (DTOs) and factory methods for validating and creating various
Notion API JSON payload objects. This package provides a comprehensive set of tools to ensure that data conforms to
the expected structure and validation rules defined by the Notion API, and to simplify the creation of these objects.
