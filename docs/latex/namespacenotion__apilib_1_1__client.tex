\hypertarget{namespacenotion__apilib_1_1__client}{}\doxysection{notion\+\_\+apilib.\+\_\+client Namespace Reference}
\label{namespacenotion__apilib_1_1__client}\index{notion\_apilib.\_client@{notion\_apilib.\_client}}


\doxysubsection{Detailed Description}
\begin{DoxyVerb}The `client` package provides the core components for interacting with the Notion API. This package contains provider classes responsible for managing communication with the Notion API, leveraging the Pydantic models defined in the data packages for validation and serialization.
