...
from _properties._filter.general import Filter
...
def create_multi_select_filter_does_not_contains(property_name: str, does_not_contain: str) -> MultiSelectFilter:
    ...
    Returns:
        MultiSelectFilter: The constructed MultiSelectFilter object with the specified property and filter criteria.
    """
    return MultiSelectFilter(property=property_name, multi_select=FilterStructure(does_not_contain=does_not_contain))
...
__all__ = ['CheckboxFilter', 'create_checkbox_filter', 'create_multi_select_filter_contains',
           'create_multi_select_filter_is_empty', 'SelectFilter', 'create_select_filter_equals',
           'create_select_filter_is_empty', 'StatusFilter', 'create_status_filter_equals',
           'create_status_filter_is_empty', 'MultiSelectFilter', 'create_multi_select_filter_does_not_contains',
           'create_status_filter_does_not_equal', 'create_select_filter_does_not_equal']
