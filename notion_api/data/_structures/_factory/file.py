...
def create_resources_attributes(
        type_: file_type, external: Optional[External] = None,
        file: Optional[FileObject] = None) -> ResourcesAttributes:
    """
...
def create_file_attributes(
        type_: file_type, caption: List[RichText], name: str, external: Optional[External] = None,
        file: Optional[FileObject] = None) -> FileAttributes:
    """
...
__all__ = ['create_file_object', 'create_external', 'create_resources_attributes', 'create_file_attributes']
